...
<body class="bg-dark">
    ...
    <selection class="row mb-5">
            ...
            <from action="#" class="p-2" id="frmCadastro">
                ...
                <div class="from group">
                    <input type="email" name="emailUsuário" id="emailUsuário" class="form-control" placeholder="E-mail de Usuário" requirede>
                </div>
                ...
                <div class="from group">
                <input type="password" name="senhaConfirmo" id="senhaConfirma" class="form-control" placeholder="Confirme sua senha" required>
                </div>

                <div class="from group">
                    <div class="custom-control custom-checkbox">
                    <input type="checkbox" name="concordar" id="concordar" class="custom-control-imput">
